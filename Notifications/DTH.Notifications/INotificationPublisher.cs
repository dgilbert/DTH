...
namespace DTH.Notifications
{
    public interface INotificationPublisher
    {
        ...
        void PublishOneTimeCharge(string customerId, string type, string amount, string chargeDate, string chargeDescription);
        ...
        /// <param name="currentBalance"></param>
        void PublishTransaction(string customerId, string cardExternalId, string amount, string transactionType, float currentBalance);
    }
}
